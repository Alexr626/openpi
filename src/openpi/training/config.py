...
FINETUNED_CHECKPOINT_DIR = os.getenv("FINETUNED_CHECKPOINT_DIR")
...
_CONFIGS = [
    ...
    *roboarena_config.get_roboarena_configs(),
    TrainConfig(
        ...
        data=PiPERDataConfig(
            assets=AssetsConfig(
                ...
                asset_id=os.path.join('pi05_piper', REPO_ID)
            ),
            repo_id=REPO_ID,
            base_config=DataConfig(prompt_from_task=True),
        ),
    ...
    TrainConfig(
        name="pi05_libero",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=ACTION_HORIZON),
        data=LeRobotLiberoDataConfig(
            repo_id="physical-intelligence/libero",
            base_config=DataConfig(prompt_from_task=True),
        ...
        ema_decay=0.999,
        pytorch_weight_path="/home/alex/dev/Franka_gello_teleoperate/base_models/pi05_libero",
        num_train_steps=30_000,
    ),
]
